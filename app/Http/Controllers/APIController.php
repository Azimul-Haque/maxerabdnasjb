    ...
    public function getCourseExams($softtoken, $id)
    {
        if($softtoken == 'Rifat.Admin.2022')
        {
            ...
            foreach($courseexams as $courseexam) {
                ...
                $courseexam->exam->makeHidden('id', 'name', 'examcategory_id', 'price_type', 'available_from', 'available_to', 'syllabus', 'created_at', 'updated_at');
            }
    ...
    public function getCourseExamQuestions($softtoken, $id)
    {
        if($softtoken == 'Rifat.Admin.2022')
        {
            ...
            foreach($examquestions as $examquestion) {
                ...
                $examquestion->question = $examquestion->question->makeHidden(['question', 'topic_id', 'difficulty', 'created_at', 'updated_at', 'questionexplanation']);
            }
