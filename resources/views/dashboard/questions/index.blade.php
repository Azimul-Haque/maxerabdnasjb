                          ...
                          @foreach($topics as $topic)
                              <tr>
                                  ...
                                  <td align="right" width="40%">
                                      ...
                                      <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteTopicModal{{ $topic->id }}">
              ...
              <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="explanation" id="explanation" placeholder="ব্যাখ্যা" style="width: 100%; height: 200px;"></textarea>
                        </div>
                    </div>
              </div>
              <div class="modal-footer">
