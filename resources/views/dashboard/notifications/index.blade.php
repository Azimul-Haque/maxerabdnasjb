                    ...
                    <tbody>
                      @foreach($notifications as $notification)
                        <tr>
                          ...
                          <td align="right">
                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#deleteModal{{ $notification->id }}" rel="tooltip" title="" data-original-title="পরীক্ষা হালনাগাদ করুন">                            </button>
