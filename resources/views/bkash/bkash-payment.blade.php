...
<div class="height d-flex justify-content-center align-items-center">
    ...
    <div class="card p-3">
        ...
        <a href="{{ route('bkash-prod-test-payment') }}" class="btn btn-danger" id="bKash_button" style="background: url({{ asset('images/bkash_payment_logo.png') }}); background-size: 100%; background-size: 250px auto; background-repeat: no-repeat;">
        </a>
    </div>
