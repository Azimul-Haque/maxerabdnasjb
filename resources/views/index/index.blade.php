            ...
            <div class="col-lg-3 col-md-6 col-12">
              <div class="pricing-style-fourteen @if($package->suggested == 1) middle @endif">
                ...
                <div class="light-rounded-buttons">
                  <button type="button" data-bs-toggle="modal" data-bs-target="#packageModal{{ $package->id }}" data-backdrop="static" class="btn @if($package->suggested == 1) primary-btn @else primary-btn-outline @endif">
                    শুরু করুন!
                  </button>
                </div>
