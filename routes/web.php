...
Route::post('bkash/production/test/payment', 'BkashController@prodPayment')->name('bkash-prod-test-payment');
Route::post('bkash/production/final/payment', 'BkashController@prodPayment')->name('bkash-prod-final-payment');
