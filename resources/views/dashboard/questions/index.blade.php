                                                ...
                                                <div class="modal-body">
                                                      ...
                                                      <div class="row">
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <center>
                                                                  <img src="@if($question->topic_id = $topic->id) {{ asset('images/placeholder.png')}} @else {{ asset('images/placeholder.png')}} @endif" id='img-upload{{ $question->id }}' style="width: 250px; height: auto;" class="img-responsive" />
                                                              </center>
                                                          </div>
                                                          <div class="col-md-6">
