                ...
                <div class="modal-content">
                  ...
                  <form method="post" action="{{ route('index.payment.proceed') }}">
                    ...
                    <div class="modal-body">
                      ...
                      <input type="number" name="user_number" onkeypress="if(this.value.length==12) return false;" class="form-control" placeholder="অ্যাপে ব্যবহৃত মোবাইল নাম্বারটি লিখুন" @if(!Auth::guest()) value="{{ Auth::user()->mobile }}" @endif required>
                    </div>
