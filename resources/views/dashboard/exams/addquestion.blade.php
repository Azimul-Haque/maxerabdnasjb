                                ...
                                <tr>
                                    <td>
                                        <div class="icheck-primary icheck-inline" style="float: left;">
                                            <input type="checkbox" id="check{{ $question->id }}" name="sitecheck[]" value="{{ $site->id }}" @if(in_array($site->id, explode(',', $user->sites))) checked="" @endif />
...
<script>
      $("#datatablemodal").DataTable({
        "responsive": true, "lengthChange": true, "autoWidth": false, info: false, "pageLength": 12,
