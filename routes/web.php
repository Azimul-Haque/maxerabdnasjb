...
Route::post('/payment/success', 'IndexController@paymentSuccessApp')->name('index.payment.success.app');
Route::post('/payment/app/confirm', 'IndexController@paymentSuccess')->name('index.payment.success');
